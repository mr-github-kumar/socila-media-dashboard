...
function Main() {
    return (
       <section className="main w-full h-auto max-w-4xl flex flex-col sm:flex-row sm:gap-6 gap-4">
           <div className="main-facebook w-full sm:w-48 h-48 bg-grayishBlue dark:bg-darkBlue rounded-lg border-t-4 border-facebook flex flex-col items-center justify-evenly shadow-lg">
               ...
               <div className="facebook-followers flex flex-col gap-1 items-center">
                   <span className="number text-darkestBlue dark:text-white text-5xl font-bold">1987</span>
           ...
           <div className="main-twitter w-full sm:w-48 h-48 bg-grayishBlue dark:bg-darkBlue rounded-lg border-t-4 border-twitter flex flex-col items-center justify-evenly shadow-lg">
               ...
               <div className="twitter-followers flex flex-col gap-1 items-center">
                   <span className="number text-darkestBlue dark:text-white text-5xl font-bold">1044</span>
                   <span className="subtitle uppercase tracking-widest text-mediumBlue font-semibold text-xs">followers</span>
               </div>
           ...
           <div className="main-instagram w-full sm:w-48 h-48 bg-grayishBlue dark:bg-darkBlue rounded-lg border-t-4 border-instagram flex flex-col items-center justify-evenly shadow-lg">
               ...
               <div className="insta-followers flex flex-col gap-1 items-center">
                   <span className="number text-darkestBlue dark:text-white text-5xl font-bold">11k</span>
                   <span className="subtitle uppercase tracking-widest text-mediumBlue font-semibold text-xs">followers</span>
               </div>
           ...
           <div className="main-youtube w-full sm:w-48 h-48 bg-grayishBlue dark:bg-darkBlue rounded-lg border-t-4 border-youtube flex flex-col items-center justify-evenly shadow-lg">
               ...
               <div className="youtube-followers flex flex-col gap-1 items-center">
                   <span className="number text-darkestBlue dark:text-white text-5xl font-bold">8239</span>
                   <span className="subtitle uppercase tracking-widest text-mediumBlue font-semibold text-xs">followers</span>
               </div>
